...
public class JspExampleApplication {
	private static final Logger log = LoggerFactory.getLogger(JspExampleApplication.class);
	...
	public CommandLineRunner demo(CustomerRepository repository) {
		return (args) -> {
			...
			for(Customer customerTest : repository.findByFirstNameAndLastName("Jack",null)) {
				log.info(customerTest.toString());
			}
			log.info("");
		};
	}
